...
if(isset($_POST["register"]))
{
	...
	if($error_user_name == '' && $error_user_email == '' && $error_user_password == '')
	{
		...
		else
		{
			...
			$mail = new PHPMailer;
			$mail->IsSMTP();
			$mail->Host = 'mail.autopors.tech';
			$mail->Port = '465';
			$mail->SMTPAuth = true;
			$mail->Username = 'noreply@autopors.tech';
			$mail->Password = 'Kunal5g377z';
			$mail->SMTPSecure = 'ssl';
			$mail->From = 'noreply@autopors.tech';
			$mail->FromName = 'AutoPors';
			...
			$message_body = '
			<p>For verify your email address, enter this verification code when prompted: <strong>'.$user_otp.'</strong>.</p>
...
<html>
 ...
 <body>
  <br />
  <div class="container">
   <h3 align="center">Register yourself for AutoPors</h3>
   <br />
